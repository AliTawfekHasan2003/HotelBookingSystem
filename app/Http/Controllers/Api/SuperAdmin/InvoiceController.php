...
class InvoiceController extends Controller
{
    ...
    /**  @OA\Get(
     *     path="/api/super_admin/dashboard/invoices",
     *     summary="Get List Of Invoices",
     *     tags={"Dashboard/Invoices"},
     *     operationId="getInvoices",
     *     security={{"bearerAuth": {}}},
     *     description="Get invoices for with 10 pagination", 
     *   @OA\Parameter(
     ...
     *             @OA\Property(property="msg", type="string", example="Invoices fetched successfully."),
     ...
     *             @OA\Property(property="msg", type="string", example="No invoices found matching the given criteria."),
    ...
    /**   @OA\Get(
     *     path="/api/super_admin/dashboard/invoices/{id}",
     ...
     *         @OA\JsonContent(
     *             @OA\Property(property="status", type="boolean", example=true),
     *             @OA\Property(property="msg", type="string", example="Invoice fetched successfully."),
     *             @OA\Property(property="code", type="integer", example=200),
     *             @OA\Property(
     *                 property="invoice",
     *                 type="array",
    ...
    /**  @OA\Get(
     *     path="/api/super_admin/dashboard/invoices/{id}/bookings",
     ...
     *         @OA\JsonContent(
     *             @OA\Property(property="status", type="boolean", example=true),
     *             @OA\Property(property="msg", type="string", example="All bookings for this invoice fetched successfully."),
     *             @OA\Property(property="code", type="integer", example=200),
     *             @OA\Property(
     *                 property="bookings",
     *                 type="array",
